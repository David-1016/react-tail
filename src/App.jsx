...
const App = () => {
  return (
    <>
      <div className="bg-[url('./assets/images/bg-desktop-light.jpg')] bg-contain bg-no-repeat bg-gray-300 
min-h-screen">
        <header className="container mx-auto px-4">
          <div className="flex justify-between pt-8">
            <h1 className="uppercase text-2xl font-simibold text-white tracking-[0.3em]">todo</h1>
        ...
        <main className="container mx-auto px-4 mt-8 ">
          <div className="bg-white rounded-md ">
            ...
            <article className="flex gap-4 border-b border-b-gray-400 px-4 py-4">
              ...
              <p className="grow text-gray-500 text-sm">Job around the park 3x</p>
